          ...
          <div className="w-2/5 bg-white rounded-lg shadow dark:border ml-0 md:mt-0 xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit(handleLogin)} noValidate>
                ...
                <button type="submit" className="w-full text-white bg-[#265253] hover:bg-primary-700 mb-2 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  Don’t have an account yet? <Link to="/auth/signup" className="font-medium text-[#265253] hover:underline dark:text-[#265253]">Sign up</Link>
                </p>
              </form>
            </div>
          </div>
